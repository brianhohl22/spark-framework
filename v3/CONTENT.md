...
Footer:
- The SPARK Team · Scottsdale Unified School District · Engaging all students in world-class, future-focused learning
- [Questions? Use Let's Talk on susd.org](https://www.susd.org/letstalk)

Browser title pattern: "Page name | SPARK | Scottsdale Unified School District". Every page: robots noindex, nofollow until public launch.

---

**PAGE 1 OF 5: HOME** · file index.html · browser title "Home | SPARK | Scottsdale Unified School District"
...
1. You send it. We confirm within 2 school days.
2. Within 3 weeks we tell you what's next. It moves to SPARK team review, joins a similar idea, or goes to a team that can act now. Or we hold it and say why.
3. The SPARK team meets four times a year. In January it chooses two or three ideas to study in depth. Most ideas do not reach this step, by design.
4. Everything studied, and what happened to it, is posted on What we're working on.

Want the full picture, including who does what and what we look for? Read [How SPARK works](how-it-works.html).

**[Planned: launch]**

## Versión en español

A Spanish version of this site and the idea form.

---

**PAGE 2 OF 5: WHAT WE'RE WORKING ON** · file working-on.html · browser title "What we're working on | SPARK | Scottsdale Unified School District"

# What we're working on

The ideas SPARK is studying, what happened to earlier ideas, and how many we've received. Counts refresh monthly. The rest updates after each quarterly SPARK team review. This page keeps the record. The work happens in school communities, led by the people who champion each idea.
...
(Anchor on this block: #studies)

### Gifted and Advanced Studies Magnet School (K-8)
...
- [June 23, 2026 presentation (PDF)](https://susd.community.diligentoneplatform.com/document/33082397-21c1-4bc3-9c3e-060b1968060f)
- [Cover memo (PDF)](https://susd.community.diligentoneplatform.com/document/f3e0c3b2-d2bd-46a4-aea1-7d29a5d3b4b7)
...
- Reviews of what SUSD already offers follow their own process. They are not listed here.
- If we leave an idea off this page, we still count it.

## You said, we did

A short note after each quarterly review: what we heard, and what changed because of it.

Table caption: You said, we did **[Example]**

| You said | We did |
| --- | --- |
| **[Example]** Parents at two elementary schools asked for more hands-on science before middle school. | **[Example]** Sent to the Curriculum team, which added a science unit review to its 2027 plan. Also on file for the next SPARK team review. |
| **[Example]** A teacher asked for later bus routes so students can stay for clubs. | **[Example]** A transportation request, not a new learning environment. Sent to the Transportation department; the teacher was told who to contact. |
...
One page: ideas received, studied, and decided.
...
- **Dedicated specialty school:** the whole school follows the theme. There is no neighborhood boundary. Families apply, and every student takes part.
...
- SUSD high schools already offer some courses that earn college credit, such as dual enrollment. Ask the school which ones.
- A full early college is not offered yet. SUSD lists Early College as a possible future theme. It was not one of the two concepts shared with the Board in June 2026.
- Have an idea? [Share it](share.html).

**Accordion:** (anchor: #gifted)
...
A short story from students and teachers in each theme.
...
**PAGE 4 OF 5: SHARE AN IDEA** · file share.html · browser title "Share an idea | SPARK | Scottsdale Unified School District"

# Share an idea

SPARK wants ideas for new learning environments and for changes to what SUSD already offers. Before you start, check three things.
...
[See the eight themes and every school](programs.html).

## Three quick questions

1. **Is it about something that already exists at one school?** Talk to that school first. Every school has a SPARK contact, the principal or a designee. They can act locally or send the idea to SPARK for you. Ideas grow best with a champion at the school.
2. **Is it one of the ideas being studied now?** Use the [Support an idea form](working-on.html#support) instead.
3. **Is it a concern about something happening now, such as a class, a bus, or a building?** Use [Let's Talk](https://www.susd.org/letstalk), SUSD's channel for questions and concerns. SPARK cannot act on these.

Not sure? Send it anyway. The SPARK team will route it.
...
2. **Within 3 weeks (15 school days):** the SPARK screener replies with one of five outcomes. Ideas sent in June and July are reviewed in August.
   ...
   - **Redirected:** another SUSD team can act on it now; we tell you who.
   - **Outside SPARK's scope:** we tell you why and where to take it.
   - **Held:** it fits SPARK, but we cannot take it up now. We tell you why and when we will look again.
3. **Quarterly SPARK team review:** advanced ideas are scored. Each is selected for study, sent back to you for more detail, or archived with a reason. You are told either way.
4. **January:** SPARK selects two or three ideas for full study that year. Results are presented in May and posted on this site.
...
The idea form in Spanish, with the same questions and reply times.

---

**PAGE 5 OF 5: HOW SPARK WORKS** · file how-it-works.html · browser title "How SPARK works | SPARK | Scottsdale Unified School District"
...
**Image:** assets/spark-work.png (800 x 560). Alt text: "SPARK's work has two parts: strengthen what we have, and explore what's next. A review can suggest an expansion or redesign, which goes to SPARK team review."
...
1. **Share.** Anyone sends an idea through the form. It gets an ID and a confirmation.
2. **Screen.** Within 3 weeks, the screener checks for overlap and fit. Outcome: advanced, merged, redirected, outside scope, or held.
3. **SPARK team review.** Quarterly, the team scores advanced ideas: selected for study, develop further, or archived with a reason. In January it selects that year's two or three studies.
4. **Study.** A design team studies each selected idea for 4 to 8 weeks and writes a one-page summary. Decision: pilot, design phase, deferred, or declined.
5. **Decide and build.** The Governing Board acts when required. Pilots and new learning environments are built and reported on this site.
...
Table caption (screen readers only): Who does what
...
1. Does it fit SUSD's direction? (Alignment and Purpose)
2. Do students and families want it, and can every student reach it? (Equity and Accessibility; Impact on Students and Staff)
3. Is the teaching sound and backed by evidence? (Evidence and Effectiveness; Data and Evaluation)
4. Can we run it: staff, space, training, timing? (Implementation Feasibility; Training and Support)
5. Can we afford it now, and in five years? (Cost and Resources; Sustainability)
6. Do partners and the community back it? (Community Partners and Stakeholder Support)
...
[Fill in the SPARK interest form](https://forms.office.com/r/rw136NR7ik)
...
**Embed:** Microsoft Form, iframe title "Site feedback form". Fallback link above it: Open the form in a new tab (opens in a new tab). Placeholder until the form exists: **[Planned: launch]** Microsoft Form will be embedded here: site feedback. The form's questions are in FORMS.md.
